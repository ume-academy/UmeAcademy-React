...
const Search = () => {
  ...
  return (
    <div>
      <div className='flex justify-between bg-white p-2 mb-6 lg:mb-0 rounded-full dark:bg-[#3d3a4e]'>
                  ...
                  <button className='bg-[#f66962] rounded-full w-[40px] md:w-[38px] lg:w-[32px] hover:bg-[#fc7f50]'>
