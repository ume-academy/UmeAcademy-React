      ...
      <div className="block lg:hidden">
        <div className="flex justify-center items-center" onClick={() => onCollapse(!collapsed)}>
          <button
            ...
            className=""
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#f66962" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-align-justify">
