import { AppstoreAddOutlined, CalendarOutlined, FolderAddOutlined, SolutionOutlined, TableOutlined, UnorderedListOutlined, UserAddOutlined, UserOutlined } from '@ant-design/icons';
