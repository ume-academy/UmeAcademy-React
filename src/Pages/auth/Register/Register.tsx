...
import bannerImgAuth from '../../../assets/images/client/auth/login_banner.png';
            ...
            <div className={`${styles['parent']} flex items-stretch `}>
                ...
                <div className={`${styles['right']} dark:text-[#B9B7C0] dark:bg-[#2b2838]  bg-[#fff]`}>
                    <div className={`${styles['top']} p-20 space-y-6`}>
                        ...
                        <div className="space-y-6">
                            ...
                            {/* <Form
                                ...
                                // onFinishFailed={}
                                autoComplete="off"
                                className={`${styles['form']} space-y-7`}
                            >
                                <Form.Item
                                    label={<span className='dark:text-[#B9B7C0] dark:bg-[#2b2838] font-subtitle'>Tên hiển thị</span>}
                                    name="fullname"
                                    rules={[{ required: true, message: 'Không được bỏ trống!' }]}
                                    className={`${styles['formGroup']}`}
                                >
                                    <Input
                                        className={`${styles['input']} py-3 dark:text-[#fff] dark:bg-[#3b3a43] `}
                                        placeholder='Tên hiển thị'
                                    />
                                </Form.Item>

                                <Form.Item
                                    label={<span className='dark:text-[#B9B7C0] dark:bg-[#2b2838] font-subtitle'>Email</span>}
                                    name="email"
                                    rules={[{ required: true, message: 'Không được bỏ trống!' }]}
                                    className={`${styles['formGroup']}`}
                                >
                                ...
                                <Form.Item
                                    label={<span className='dark:text-[#B9B7C0] dark:bg-[#2b2838] font-subtitle'>Mật khẩu</span>}
                                    name="password"
                                    rules={[{ required: true, message: 'Không được bỏ trống!' }]}
                                    className={`${styles['formGroup']}`}
                                >
                                ...
                                <Form.Item
                                    className={`${styles['formGroup']}`}
                                >
                                    <Button type="primary" htmlType="submit" className={`${styles['btn']} font-subtitle text-lg py-6 mt-6`}>
                                        Đăng ký
                                    </Button>
                                </Form.Item>
                    ...
                    <div className={`${styles['others']} dark:bg-[#5C505B] bg-[#FFF5F4] flex flex-col items-center space-y-6 py-6`}>
                        ...
                        <div className="">
                            <p>Đã có tài khoản? Đăng nhập ngay <Link to={''} className='font-subtitle text-[#FF875A]'>tại đây</Link></p>
                        </div>
                    </div>
                </div>
            </div >
