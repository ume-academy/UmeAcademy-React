...
const List_Withdrawal_Requests = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: 'price',
      dataIndex: 'price',
      render: (price: number) => <p>{price?.toLocaleString('vi-VN')}đ</p>,
      width: 120
    },
    {
      title: 'Thời gian',
    ...
    },
    {
      ...
      render: (status: 0 | 1 | 2) => (
        <Tag
          ...
          color={status === 0 ? 'blue' : status === 1 ? 'green' : 'red'}
        >
  ...
  return (
    <div className='dark:text-[#B9B7C0] dark:bg-[#2b2838] bg-white text-[#685f78] rounded-lg p-4'>
      ...
      <div className='flex flex-col lg:flex-row lg:justify-between mb-4'>
        <p className='text-xl font-semibold'>Danh sách yêu cầu rút tiền</p>
        ...
        >
          <div className='dark:text-gray-300 text-gray-700 space-y-2'>
            <p className='font-semibold'>
              Họ và tên: <span className='font-normal'>Vũ Ngọc Giao</span>
            </p>
            <p className='font-semibold'>
              Phương thức: <span className='font-normal'>Chuyển khoản ngân hàng</span>
            </p>
            <p className='font-semibold'>
              Ngân hàng hưởng thụ: <span className='font-normal'>MB Bank</span>
            </p>
            <p className='font-semibold'>
              Số tài khoản: <span className='font-normal'>998111999</span>
            </p>
