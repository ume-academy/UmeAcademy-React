...
export const backgroundImageCommon =
  "./src/assets/images/client/homeBGR/banner.png"; //biến dùng cho bgr dùng chung

export const imageIntroduce =
  "./src/assets/images/client/homeBGR/introduce.png"; //biến dùng cho bgr dùng chung
