      ...
      >
        ...
        >
          <div className='justify-self-start'>
            ...
            <h1 className='mb-[20px] leading-[60px] text-[#22100d] dark:text-[#B9B7C0] text-[48px] max-w-[500px] font-title'>
              Các khóa học trực tuyến hấp dẫn và dễ tiếp cận dành cho tất cả mọi người
            </h1>
            <p className='mb-[30px] text-[#685f78] dark:text-[#B9B7C0] text-[18px]'>
              Sở hữu tương lai của bạn bằng cách học các kỹ năng mới trực tuyến
            </p>
            <p className='text-[#685f78] dark:text-[#B9B7C0] text-[20px] mb-[10px]'>
