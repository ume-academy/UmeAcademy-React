...
const images = [
  {
    src: 'https://dreamslms.dreamstechnologies.com/html/assets/img/categories-icon-02.png',
    title: 'Angular Development',
    instructors: 40
  },
  {
    src: 'https://dreamslms.dreamstechnologies.com/html/assets/img/categories-icon-03.png',
    title: 'Docker Development',
    instructors: 45
  },
  {
    src: 'https://dreamslms.dreamstechnologies.com/html/assets/img/categories-icon-04.png',
          ...
          <SwiperSlide key={index}>
            <div className='bg-white dark:bg-[#2b2838] dark:border-transparent dark:hover:bg-[#413655] border-[1px] rounded-lg p-5 text-center flex flex-col items-center hover:bg-[#413655] group transition-all duration-300 ease-in-out'>
              ...
              <div className='max-w-[130px] mx-auto'>
                ...
                <p className='text-gray-600 text-[14px] group-hover:text-[#fff] dark:text-[#B9B7C0] transition-all duration-300 ease-in-out'>
                  {image.instructors} Instructors
                </p>
              </div>
            </div>
          </SwiperSlide>
