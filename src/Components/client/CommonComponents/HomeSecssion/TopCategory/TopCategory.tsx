    ...
    return (
        ...
        <div className='max-w-[1296px] mx-auto pb-[80px]'>
            ...
            <motion.div 
                ...
                <Link to={``} className="mr-[20px] border-[2px] min-w-[140px] transition-all duration-300 ease-in-out dark:text-[#b9b7c0] flex justify-center items-center rounded-3xl border-[#b4a7f5] text-[#392c7d] px-[15px] py-[10px] hover:bg-[#917cf6] hover:border-transparent dark:hover:text-[#fff] hover:text-[#fff]">Tất cả các danh mục</Link>
            </motion.div>
            <motion.p 
                initial={{y: 100, opacity: 0}}
                ...
                transition={{ duration: 1, ease: easeInOut }}
                ref={bottomRef}
                className='max-w-[700px] text-[#685f78] dark:text-[#B9B7C0] mb-[80px]'> Khám phá danh mục hàng đầu với những khóa học chất lượng cao, được thiết kế để giúp bạn nâng cao kỹ năng và kiến thức. Từ các khóa học chuyên sâu cho đến các chương trình đào tạo ngắn hạn, hãy tìm cho mình lộ trình học tập phù hợp để mở rộng sự nghiệp và đạt được mục tiêu cá nhân. Tham gia ngay để không bỏ lỡ cơ hội phát triển bản thân!
            </motion.p>
            <SliderCategory />
        </div>
            </>
